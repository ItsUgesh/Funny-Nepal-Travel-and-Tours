...
if (!class_exists('WP_Bootstrap_Navwalker')) {
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            ...
            $output .= "\n$indent<ul class=\" submenu collapse\" >\n";
        }
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            if (0 === strcasecmp($item->attr_title, 'divider') && 1 === $depth) {
                ...
                $item_output .= ($args->has_children && 0 === $depth) ? ' <i class="fa-sharp fa-solid fa-caret-down"></i></a>' : '</a>';
        ...
        public static function fallback($args)
        {
            if (current_user_can('edit_theme_options')) {
                ...
                echo '>';
                echo '<li><a class="nav-link" href="' . esc_url(admin_url('nav-menus.php')) . '">' . esc_attr('Add a menu', '') . '</a></li>';
                echo '</ul>';
                if ($container) {
                    echo '</' . esc_attr($container) . '>';
                }
